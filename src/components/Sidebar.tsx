...
const NavLink: any = React.forwardRef((props: any, ref: any) => (
...
const Brand = styled<any>(ListItem)`
...
const Link = styled<any>(ListItem)`
...
class Sidebar extends React.Component<any, any> {
  ...
  render() {
    const { classes, staticContext, ...other }: any = this.props;

    return (
      <Drawer variant="permanent" {...other}>
        <Brand>
          <BrandIcon /> <Box ml={1}>BounceCode Hexa</Box>
        </Brand>
        <Scrollbar>
          <List disablePadding>
            <Items>
